<?php
    ...
    if(isset($_REQUEST["new_post"])) {
        ...
        $sql = "INSERT INTO my_blog(title, content) VALUES('$title', '$content')";
    ...
    if(isset($_REQUEST['id'])) {
        ...
        $sql = "SELECT * FROM my_blog WHERE id = $id";
        $query = mysqli_query($connect, $sql);
    }
    ...
    if(isset($_REQUEST['update'])) {
        ...
        $sql = "UPDATE my_blog SET title = '$title', content = '$content' WHERE id = $id";
        mysqli_query($connect, $sql);
    ...
    if(isset($_REQUEST['delete'])) {
        ...
        $sql = "DELETE FROM my_blog WHERE id = $id";
        $query = mysqli_query($connect, $sql);
